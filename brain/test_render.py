...
test = """@startuml CU01_Clases
allowmixing
title 3.3.3 Clases de Entidad (Entity)\\n\\nCU01. Registrar Usuario
...
ActCliente -right- RegistroView
RegistroView -right- RegistroController
RegistroController -right- User
@enduml"""

url = plantuml_url(test)
req = urllib.request.Request(url, headers={'User-Agent': 'Mozilla/5.0'})
resp = urllib.request.urlopen(req)
print("TEST STATUS:", resp.getcode())
with open("c:/Parcial-si2/brain/cu01_rendered.png", "wb") as f:
    f.write(resp.read())
